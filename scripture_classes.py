...
class DownloadManager:
    ...
    def download_audio(self):
        ...
        output_audio.export(f"static/output/{self.scripture_object.bible_book}_{self.scripture_object.chapter}.{self.scripture_object.verses_string}.wav", format="wav")
